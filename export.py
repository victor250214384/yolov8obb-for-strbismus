...
from models.yolo import Detect_v8
...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    ...
    try:
        ...
        torch.onnx.export(
            ...
            # output_names = ['bboxes ','scores','theta'],
            dynamic_axes={
                'images': {0: 'batch',2: 'height',3: 'width'},  # shape(1,3,640,640)
                'output_0': {0: 'batch', 1: 'anchors'},  # shape(1,25200,85)
                'output_1': {0: 'batch', 1: 'anchors'},  # shape(1,25200,85)
                'output_2': {0: 'batch', 1: 'anchors'}  # shape(1,25200,85)
...
def run(data=ROOT / 'data/coco128.yaml',  # 'dataset.yaml path'
        ...
        imgsz=(480, 640),  # image (height, width)
